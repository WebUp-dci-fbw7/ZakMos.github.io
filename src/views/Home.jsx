    ...
    return (
       <div className="center">
        <Jumbotron>
          ...
          <p className="lead mt-1">I have worked on several projects involving HTML5, CSS3, AJAX, Git, Version Control, Testing, JavaScript, Jquery, React, Redux, NodeJS, MongoDB, MySQL, Express, and I have self studyied phaser3, PHP, PHP-Laravel, and Angular, Currently I am looking for new challenges as Junior Full Stack Web Developer.
          </p>
